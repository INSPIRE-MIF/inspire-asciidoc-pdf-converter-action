:icons: font
:numbered:
:title: AsciiDoctor PDF Converter Action
ifdef::env-github[:outfilesuffix: .adoc]

IMPORTANT: This is a cloned repository modified to enable conversion of multiple asciidoc files to pdf versions. Not enabled to use with github pages!
